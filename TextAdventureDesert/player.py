...
class Player:
    def __init__(self):
        self.inventory = [items.Gold(15), items.Rock(), items.APotion()]  # Inventory on startup
    ...
    def punch(self, enemy):
        ...
        # print("You use {} against {}!".format(best_weapon.name, enemy.name))
        print("You punched {}!".format(enemy.name))
        enemy.hp -= best_weapon.damage
        if not enemy.is_alive():
            print("You killed {}!".format(enemy.name))
        else:
    ...
    def kick(self, enemy):
        ...
        print("You kicked {}!".format(enemy.name))
        enemy.hp -= best_weapon.damage
        if not enemy.is_alive():
            print("You killed {}!".format(enemy.name))
        else:
    ...
    def jump(self, enemy):
        ...
        print("You jumped above the {}!".format(enemy.name))
        enemy.hp -= best_weapon.damage
        if not enemy.is_alive():
            print("You killed {}!".format(enemy.name))
        else:
